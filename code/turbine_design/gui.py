...
def initial_screen():  # cria janela principal
    ...
    develops_label.pack()
    develops_label = tk.Label(initial_window, text="Turbomachinery Department\n",
                              font=("times new roman", 18, "bold"))
    develops_label.pack()
...
def ita_logo_plot():
    file_logo = 'images/ita_logo.png'
    fig, axs = plt.subplots(figsize=(6, 2))
    axs.imshow(img.imread(file_logo))
    plt.axis('off')
    return fig
...
# data_stress = pd.read_csv('permissible_stress.csv',
#                           header=None, skiprows=[0, 1])
# data_B = pd.read_csv('gas_bending_B_coefficient.csv',
#                      header=None, skiprows=[0, 1])
# data_n = pd.read_csv('gas_bending_n_coefficient.csv',
#                      header=None, skiprows=[0, 1])
# data_visc_air_temp = pd.read_csv(
#     'visc_air_temp.csv', header=None, skiprows=[0, 1])
